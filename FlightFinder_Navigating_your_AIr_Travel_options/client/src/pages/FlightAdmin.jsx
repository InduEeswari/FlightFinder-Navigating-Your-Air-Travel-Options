        ...
        <>
          {userDetails.approval === 'not-approved' ?
            <div className="notApproved-box">
              ...
              <p>Your application is currently under review. Approval from the administrator is pending. We appreciate your patience!!</p>
            </div>
          ...
          : userDetails.approval === 'rejected' ?
            <div className="notApproved-box">
              ...
              <p>We understand your interest, but your request has been declined!!</p>
          </div>
          : userDetails.approval === 'approved' ?
            

          <div className="flight-admin-cards-vertical">
